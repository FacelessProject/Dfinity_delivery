...
} from "./chunk-YYQU5O4S.js";
import "./chunk-7T45EBAY.js";

// node_modules/@animxyz/vue3/node_modules/clsx/dist/clsx.m.js
function r(e) {
  var t, f, n = "";
...
// node_modules/@animxyz/vue3/dist/VueAnimXyz.esm.js
init_runtime_core_esm_bundler();
...
function mergeData() {
  ...
  return Object.assign({}, data1, data2, {
    ...
    class: clsx_m_default(data1 === null || data1 === void 0 ? void 0 : data1.class, data2 === null || data2 === void 0 ? void 0 : data2.class)
  });
}
function getXyzTransitionData(data) {
  deleteUndefined(data);
  data.appear = Boolean(data.appear || data.appearVisible);
  var appear = data.appear, appearVisible = data.appearVisible, duration = data.duration;
...
function updateDirective(el, _ref) {
  ...
  el.setAttribute("xyz", clsx_m_default(el._xyzOriginal, value));
}
var xyz = {
...
var VueAnimXyz_esm_default = VueAnimXyz;

// dep:@animxyz_vue3
var animxyz_vue3_default = VueAnimXyz_esm_default;
export {
  XyzTransition,
  XyzTransitionGroup,
  animxyz_vue3_default as default,
  xyz
};
//# sourceMappingURL=@animxyz_vue3.js.map
