    ...
    var JsonDefaultCborEncoder = class {
      ...
      encode(value2) {
        switch (typeof value2) {
          ...
          case "boolean":
            return cbor3.bool(value2);
          case "number":
            if (Math.floor(value2) === value2) {
              return cbor3.number(value2);
            } else {
              return cbor3.doubleFloat(value2);
            }
          case "string":
            return cbor3.string(value2);
          case "object":
            if (value2 === null) {
              return cbor3.null_();
            } else if (Array.isArray(value2)) {
              return cbor3.array(value2.map((x) => this._serializer.serializeValue(x)));
            } else if (BufferClasses.find((x) => value2 instanceof x)) {
              return cbor3.bytes(value2.buffer);
...
var import_borc = __toModule(require_src());
var cbor = __toModule(require_src2());
var import_simple_cbor = __toModule(require_src2());
...
var import_borc2 = __toModule(require_src());
...
var base64Arraybuffer = __toModule(require_base64_arraybuffer());
 ...
 * @license  MIT
 */
//# sourceMappingURL=chunk-RLEQAQSS.js.map
