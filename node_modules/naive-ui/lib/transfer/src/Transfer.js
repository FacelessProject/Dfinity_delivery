...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const { uncontrolledValueRef, mergedValueRef, targetValueSetRef, valueSetForSelectAllRef, valueSetForUnselectAllRef, targetOptionsRef, filteredSrcOptionsRef, canNotSelectAnythingRef, canBeClearedRef, allCheckedRef, srcPatternRef, handleSrcFilterUpdateValue } = (0, use_transfer_data_1.useTransferData)(props);
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { class: [
            ...
            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-transfer-list ${mergedClsPrefix}-transfer-list--source` },
                (0, vue_1.h)(TransferHeader_1.default, { source: true, title: this.sourceTitle, onCheckedAll: this.handleCheckedAll, onClearAll: this.handleClearAll, size: this.mergedSize }),
                (0, vue_1.h)("div", { class: `${mergedClsPrefix}-transfer-list-body` },
                    this.filterable ? ((0, vue_1.h)(TransferFilter_1.default, { onUpdateValue: this.handleSrcFilterUpdateValue, value: this.srcPattern, disabled: this.mergedDisabled, placeholder: this.sourceFilterPlaceholder })) : null,
            ...
            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-transfer-list ${mergedClsPrefix}-transfer-list--target` },
                (0, vue_1.h)(TransferHeader_1.default, { onClearAll: this.handleClearAll, size: this.mergedSize, title: this.targetTitle }),
                (0, vue_1.h)("div", { class: `${mergedClsPrefix}-transfer-list-body` },
                    (0, vue_1.h)("div", { class: `${mergedClsPrefix}-transfer-list-flex-container` },
                        (0, vue_1.h)(TransferList_1.default, { options: this.tgtOpts, disabled: this.mergedDisabled, virtualScroll: this.virtualScroll, itemSize: this.itemSize }))),
                (0, vue_1.h)("div", { class: `${mergedClsPrefix}-transfer-list__border` }))));
    }
});
