...
export declare type TransferRenderTargetLabel = (props: RenderLabelProps) => VNodeChild;
export declare type TransferRenderSourceLabel = (props: RenderLabelProps) => VNodeChild;
export interface RenderListProps {
    onCheck: (checkedValueList: OptionValue[]) => void;
    checkedOptions: Option[];
    pattern: string;
}
export declare type TransferRenderSourceList = (props: RenderListProps) => VNodeChild;
